...
namespace KEDI.Core.Premise.Models.Sale
{
    ...
    public class SaleDelivery
    {
        ...
        public IEnumerable<SaleDeliveryDetail> SaleDeliveryDetails { get; set; }
        public int BaseOnID { get; set; }
      
    }
    // draft
    public class DraftDelivery
    {
        [Key]
        ...
        [NotMapped]
        public FreightSale FreightSalesView { get; set; }
        public IEnumerable<DraftDeliveryDetail> DraftDeliveryDetails { get; set; }
        public int BaseOnID { get; set; }
