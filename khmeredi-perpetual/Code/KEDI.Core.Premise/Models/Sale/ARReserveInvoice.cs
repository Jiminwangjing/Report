...
{
    [Table("ARReserveInvoice")]
    public class ARReserveInvoice
    {
        [Key]
        ...
        public IEnumerable<ARReserveInvoiceDetail> ARReserveInvoiceDetails { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
    }
    // draft
    public class DraftReserveInvoice
    {
        [Key]
        public int ID { get; set; }
        ...
        [NotMapped]
        public FreightSale FreightSalesView { get; set; }
        public IEnumerable<DraftReserveInvoiceDetail>DraftReserveInvoiceDetails  { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
