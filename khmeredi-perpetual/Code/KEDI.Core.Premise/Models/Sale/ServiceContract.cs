...
namespace KEDI.Core.Premise.Models.Sale
{
    ...
    public class ServiceContract
    {
        ...
        public List<ServiceContractDetail> ServiceContractDetails { get; set; }
        public List<AttchmentFile> AttchmentFiles { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
       
    }
    public class DraftServiceContract
    {
        [Key]
        public int ID { get; set; }
        ...
        [NotMapped]
        public FreightSale FreightSalesView { get; set; }
        public List<DraftServiceContractDetail> DraftServiceContractDetails { get; set; }
        public List<DraftAttchmentFile> DraftAttchmentFiles { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
