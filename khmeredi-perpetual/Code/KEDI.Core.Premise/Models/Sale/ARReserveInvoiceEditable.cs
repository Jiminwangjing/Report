...
namespace KEDI.Core.Premise.Models.Sale
{
    ...
    public class ARReserveInvoiceEditable
    {
        [Key]
        ...
        public bool Delivery { get; set; }
         public bool Paded { get; set; }
        
        [NotMapped]
        public FreightSale FreightSalesView { get; set; }
        public IEnumerable<ARReserveInvoiceEditableDetail> ARReserveInvoiceEditableDetails { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
    }
   
    // draft
    public class DraftReserveInvoiceEditable
    {
        [Key]
        public int DraffID { get; set; }
        ...
        [NotMapped]
        public FreightSale FreightSalesView { get; set; }
        public IEnumerable<DraftReserveInvoiceEditableDetail>DraftReserveInvoiceEditableDetails  { get; set; }
        [NotMapped]
        public List<SaleARDPINCN> SaleARDPINCNs { get; set; }
