...
{
    public class PurchaseCreditMemoDetialViewModel
    {
    ...
    public class PurchaseCreditMemoViewModel
    {
    ...
    public class PurchaseCreditMemoUpdateViewModel
    {
        public PurchaseCreditMemoViewModel PurchaseCreditMemo { get; set; }
        public List<PurchaseCreditMemoDetialViewModel> PurchaseCreditMemoDetials { get; set; }
