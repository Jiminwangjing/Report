...
{
    public class PurchasePODetialViewModel
    {
    ...
    public class PurchasePOUpdateViewModel
    {
        public PurchasePOViewModel PurchasePO { get; set; }
        public List<PurchasePODetialViewModel> PurchasePODetials { get; set; }
