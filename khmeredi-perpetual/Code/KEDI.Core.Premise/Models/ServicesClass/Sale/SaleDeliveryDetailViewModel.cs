...
{
    public class SaleDeliveryDetailViewModel
    {
    ...
    public class SaleDeliveryUpdateViewModel
    {
        public SaleDeliveryViewModel SaleDelivery { get; set; }
        public List<SaleDeliveryDetailViewModel> SaleDeliveryDetails { get; set; }
    }
