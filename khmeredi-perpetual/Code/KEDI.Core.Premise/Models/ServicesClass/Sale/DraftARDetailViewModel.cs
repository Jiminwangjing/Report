...
{
    public class DraftARDetailViewModel
    {
    ...
    public class DraftARUpdateViewModel
    {
        public DraftARViewModel SaleDraft { get; set; }
        public List<DraftARDetailViewModel> DraftARDetail { get; set; }
    }
    public class DraftARViewModel
    {
        public int DraftID { get; set; }
