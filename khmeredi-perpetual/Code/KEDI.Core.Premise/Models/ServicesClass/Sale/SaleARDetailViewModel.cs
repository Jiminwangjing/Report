...
{
    public class SaleARDetailViewModel
    {
    ...
    public class SaleARUpdateViewModel
    {
        public SaleARViewModel SaleAR { get; set; }
        public List<SaleARDetailViewModel> SaleARDetails { get; set; }
    }

    public class SaleARViewModel
    {
        public int SARID { get; set; }
    ...
    public class ServiceContractUpdateViewModel
    {
        public ServiceContractViewModel ServiceContract { get; set; }
        public List<ServiceContractDetialViewModel> ServiceContractDetail { get; set; }
        public List<AttchmentFileViewModels> AttchmentFileDetail { get; set; }
    }
    public class AttchmentFileViewModels
    {
    ...
    public class ServiceContractViewModel
    {
        ...
        public string PriListName { get; set; }
        public int UserID { get; set; }
        public int SaleCurrencyID { get; set; }
    ...
    public class ServiceContractDetialViewModel
    {
        public string LineID { get; set; }
        public int ServiceContractIDD { get; set; }
        public int ID { get; set; }
        public int SQDID { get; set; }
        public int SODID { get; set; }
        public int SDDID { get; set; }
