...
{
    public class ReturnDeliveryDetailViewModel
    {
    ...
    public class ReturnDeliveryUpdateViewModel
    {
        public ReturnDeliveryViewModel ReturnDelivery { get; set; }
        public List<ReturnDeliveryDetailViewModel> ReturnDeliveryDetails { get; set; }
    }
    public class ReturnDeliveryViewModel
    {
        public int ID { get; set; }
