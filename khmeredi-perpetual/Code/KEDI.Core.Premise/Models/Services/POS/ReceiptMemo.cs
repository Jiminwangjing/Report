...
{
    public class ReceiptMemo : ISyncEntity
    {
        [Key]
        ...
        [Required]
        public string ReceiptMemoNo { get; set; }
        [Required]
        ...
        public double GrandTotalDisplay { get; set; }
        public double ChangeDisplay { get; set; }
        [Required]
        ...
        [NotMapped]
        public List<ReceiptDetailMemo> ReceiptDetailMemos { set; get; }
        //ISyncEntity
