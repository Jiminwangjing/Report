...
{
    [Table("tbGoodsReceiptReturnDetail",Schema ="dbo")]
    public class GoodsReceiptPoReturnDetail
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int GoodsReturnDetailID { get; set; }
        public int GoodsReceiptPoReturnID { get; set; }
