$(document).ready(function () {
    ...
    $(".add-group-1").click(function () {
        ...
        dialog.invoke(function () {
            ...
            $.get("/BusinessPartner/GetGroup1", { type: "Customer" }, function (respones) {
    ...
    $(".add-group-2").click(function () {
        ...
        dialog.invoke(function () {
            ...
            $.get("/BusinessPartner/GetGroup2", { type: "Customer" }, function (respones) {
    ...
    $("#slg1").change(function () {
        ...
        if (value != 0) {
            $.get("/BusinessPartner/GetGroup2", { value: value, type: "Customer" }, function (res) {
        ...
        if (count > 0) {
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("#mgoup2").val("");
                    $("#txt_group2name").val("");
                    $.get("/BusinessPartner/GetGroup1", { value: 0, type: "Customer" }, function (rest) {
                    ...
                    $.get("/BusinessPartner/GetGroup2", { value: 0, type: "Customer" }, function (res) {
                        let addOption = "<option value='0' selected>--- Select ---</option>";
                        $.each(res, function (i, item) {
                            addOption +=
                                '<option value="' + item.ID + '">' + item.Name + '</option>';
    ...
    $("#txt_saleemp").click(function () {
        ...
        dialog.invoke(function () {
            $.get("/BusinessPartner/GetSaleEmployee", function (resp) {
