...
const __filterType = {
    ...
    SaleType: 9//{ Quotation = 1, Order = 2, Delivery = 3, AR = 4, CreditMemo = 5 }
}
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        let method = "SaleARHistoryEdit";
                        if (vatnumber == 1)
                            method = "SaleARHistoryTp01";
                        if (vatnumber == 2)
                            method = "SaleARHistoryTp02";
                        if (vatnumber == 3)
                            method = "SaleARHistoryTp03";
                        if (vatnumber == 4)
                            method = "SaleARHistoryTp04";
                        if (vatnumber == 5)
                            method = "SaleARHistoryTp05";
                        if (vatnumber >= 1) {
                            let __printUrl = `${_printUrlAR}Home/${method}/?id=${ID}`;
                            window.open(__printUrl, "_blank");
                        }
                        else {
                            method = "SaleARHistoryEdit";
                            window.open("/Print/SaleARHistoryEdit?id=" + ID + "", "_blank");
                        }
                    }
                }
            }
