...
const __filterType = {
    ...
    SaleType: 6 //{ Quotation = 1, Order = 2, Delivery = 3, AR = 4, CreditMemo = 5 }
}
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        let method = "ReturnDeliveryHistory";
                        if (vatnumber == 1)
                            method = "ReturnDeliveryHistory";
                        if (vatnumber == 2)
                            method = "ReturnDeliveryHistory";
                        if (vatnumber >= 1) {
                            ...
                            method = "ReturnSaleDeliveryHistory";
