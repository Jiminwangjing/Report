...
const __filterType = {
    ...
    SaleType: 3 //{ Quotation = 1, Order = 2, Delivery = 3, AR = 4, CreditMemo = 5 }
}
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        let method = "SaleDeliveryHistory";
                        if (vatnumber == 1)
                            method = "SaleDeliveryHistoryNonVat";
                        if (vatnumber == 2)
                            method = "SaleDeliveryHistoryVat";
                        if (vatnumber >= 1) {
