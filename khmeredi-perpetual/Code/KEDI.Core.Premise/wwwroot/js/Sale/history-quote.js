...
const __filterType = {
    ...
    SaleType: 1 //{ Quotation = 1, Order = 2, Delivery = 3, AR = 4, CreditMemo = 5 }
}
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        let method = "SaleQuoteHistory";
                        if (vatnumber == 1)
                            method = "SaleQuoteHistoryNoneVat";
                        if (vatnumber == 2)
                            method = "SaleQuoteHistoryVat";
                        if (vatnumber >= 1) {
