...
const __filterType = {
    ...
    SaleType: 10, //{ Quotation = 1, Order = 2, Delivery = 3, AR = 4, CreditMemo = 5,ARReEDT=10 }
}
...
$("#btn-fillter").click(() => {
    ...
    __filterType.Customer = parseInt(customer);
    __filterType.Warehouse = parseInt(warehouse);
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        let method = "ARReserveEditableHistory";
                        if (vatnumber == 1)
                            method = "ARReserveEdit01History";
                        if (vatnumber == 2)
                            method = "SaleARReserveHistoryVat";
                        if (vatnumber == 3)
                            method = "ARReserveHistoryVatB";
                        if (vatnumber == 4)
                            method = "ARReserveHistoryVatC";
                        if (vatnumber == 5)
                            method = "SaleAReserveNoneVat01History";
                        if (vatnumber >= 1) {
