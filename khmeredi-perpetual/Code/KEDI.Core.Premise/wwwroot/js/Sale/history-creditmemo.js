...
function bindSaleHistories(selector, data) {
    ...
    let $listhistory = ViewTable({
        ...
        visibleFields: ["InvoiceNo", "CustomerName", "BalanceDueLC", "PostingDate", "DocumentDate", "DueDate", "Status", "VatTypeB"],
        columns: [
            {
                name: "VatTypeB",
                template: `<select>`,
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        let ID = e.data.ID;
                        let method = "SaleArCreditmemotHistory";
