...
_data.PropertyDetails.forEach(i => {
    i.ID = 0;
});
let config = {
    master: {
...
$(document).ready(function () {
    ...
    $("#btn-copy").on("click", function () {
        ...
        coreMaster.updateData("/ItemMasterData/Copy", ["itemMaster", "itemAccounting", "properties"], function (res) {
    ...
    if (_data.ItemMasterData.Process == "SEBA") {
        $(".seba").prop("hidden", false);
    }
    ...
    let $listJE = ViewTable({
        ...
        columns: [
            ...
            },
            {
                ...
                template: "<input type='number' name='max' class='number'>",
                on: {
                    "keyup": function (e) {
                        let key = $(this).parent().parent().find("td:eq(4)").text();
