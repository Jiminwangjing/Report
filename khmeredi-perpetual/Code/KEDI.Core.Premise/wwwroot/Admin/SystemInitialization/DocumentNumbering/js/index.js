                ...
                yes: {
                    ...
                    callback: function (e) {
                        if (parseInt($("#idSeriesUpdate").val()) == 0) {
                            ...
                            const periodIndecator = e.meta._content.children().children(".box-body")
                                .children("table").children("tr:last-child").children("td:nth(7)").children().val();
        ...
        dialog.invoke(function () {
            let $listActiveGL = ViewTable({
                ...
                columns: [
                    ...
                    {
                        name: "FirstNo",
                        template: "<input type='number' class='disabled'>",
                        on: {
                            "keyup": function (e) {
                    ...
                    {
                        name: "NextNo",
                        template: "<input type='text' class='disabled nextNo' readonly disabled>",
                    },
                    {
                        name: "LastNo",
                        template: "<input type='text'  class='disabled'>",
