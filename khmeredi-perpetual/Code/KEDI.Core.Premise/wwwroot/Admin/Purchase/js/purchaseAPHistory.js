    ...
    function GetPurchaseAPReport() {
        ...
        $.get("/PurchaseAP/GetPurchaseAPReport", { BranchID: BranchID, warehouseID: warehouse, VendorID: Vendor, PostingDate: postingdate, DocumentDate: documentDate, DeliveryDate: delivery, Search, Check: check }, function (res) {
                    ...
                    on: {
                        "click": function (e) {
                            ...
                            if (vatnumber >= 1) {
                                ...
                                window.open(_printUrl + "Home/PrintPurchaseAP/?purchaseId=" + purchaseId + "", "_blank");
                            }
                            else {
                                window.open("/Print/PrintPurchaseAP?PurchaseID=" + purchaseId + "", "_blank");
                            }
                        }
                    }
                }
