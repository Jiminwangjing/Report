...
function GetPurchaseOrderReport() {
    ...
    $.get("/PurchaseOrder/GetPurchaseOrderReport", { BranchID: BranchID, WarehouseID: warehouse, VendorID: Vendor, PostingDate: postingdate, DocumentDate: documentDate, DeliveryDate: delivery, Search, Check: check }, function (res) {
        ...
        actions: [
            {
                ...
                on: {
                    "click": function (e) {
                        ...
                        if (vatnumber >= 1) {
                            window.open(_printUrl + "Home/PurchaseOrder/?purchaseid=" + purchaseid + "", "_blank");
                        }
                        else {
                            window.open("/Print/PrintPurchaseOrder?PurchaseID=" + purchaseid + "", "_blank");
                        }
                    }
                }
            }
