...
namespace KEDI.Core.Security.Cryptography
{
    ...
    {       
        ...
        public static RSA ImportPrivateKey(byte[] privateKey)
        {
            var rsa = Create();
        ...
        public static RSA ImportPublicKey(string publicKeyBase64String)
        {
            var rsa = Create();
        ...
        public static RSA ImportPrivateKey(string privateKeyBase64String)
        {
            var rsa = Create();
        ...
        //Sign & verify data with specified hash algorithm in bytes array format keys
        public static string SignData(string plainData, byte[] rsaPrivateKey, object halg)
        {
            using (var rsaWrite = new RSACryptoServiceProvider())
            {
                rsaWrite.ImportRSAPrivateKey(rsaPrivateKey, out int _bytesRead);
        ...
        public static bool VerifyData(string plainData, string signedData, byte[] rsaPublicKey, object halg)
        {
            using (var rsaRead = new RSACryptoServiceProvider())
            {
                rsaRead.ImportRSAPublicKey(rsaPublicKey, out int _bytesRead);
                byte[] plainBytes = Encoding.Unicode.GetBytes(plainData);
        ...
        //SHA-256 in bytes array keys
        public static string SignDataSHA256(string plainData, byte[] rsaPrivateKey)
        {
            return SignData(plainData, rsaPrivateKey, new SHA256CryptoServiceProvider());
        }

        public static bool VerifyDataSHA256(string plainData, string signedData, byte[] rsaPublicKey)
        {
            return VerifyData(plainData, signedData, rsaPublicKey, new SHA256CryptoServiceProvider());
        }
        ...
        //SHA-384 in bytes array keys
        public static string SignDataSHA384(string plainData, byte[] rsaPrivateKey)
        {
            return SignData(plainData, rsaPrivateKey, new SHA384CryptoServiceProvider());
        }

        public static bool VerifyDataSHA384(string plainData, string signedData, byte[] rsaPublicKey)
        {
            return VerifyData(plainData, signedData, rsaPublicKey, new SHA384CryptoServiceProvider());
        }
        ...
        //SHA-512 in bytes array format keys
        public static string SignDataSHA512(string plainData, byte[] rsaPrivateKey)
        {
            return SignData(plainData, rsaPrivateKey, new SHA512CryptoServiceProvider());
        }

        public static bool VerifyDataSHA512(string plainData, string signedData, byte[] rsaPublicKey)
        {
            return VerifyData(plainData, signedData, rsaPublicKey, new SHA512CryptoServiceProvider());
        }
