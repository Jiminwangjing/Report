...
$('#pay-cash').keypress(function (event) {
...
function calulatePayment() {
    ...
    let __conv_curr_change = numeral(conv_curr_change).format('0.000');
    ...
    $('#pay-change-display-curr').val(isNaN(__conv_curr_change) ? "0.000" : __conv_curr_change);
